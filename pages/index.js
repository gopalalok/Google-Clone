...
export default function Home() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      ...
      <form className="flex flex-col flex-grow items-center mt-22 w-4/5">
        <Image src="https://storage.googleapis.com/gd-wagtail-prod-assets/original_images/evolving_google_identity_2x1.jpg" width={500} height={180} />
